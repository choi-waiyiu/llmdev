...
# ===== グラフを実行する関数 =====
def stream_graph_updates(graph: StateGraph, system_message: str, user_message: str, thread_id):
    """
...
# ===== 応答を返す関数 =====
def get_bot_response(system_message, user_message, memory, thread_id):
    """
    ...
    # グラフを実行してボットの応答を取得
    return stream_graph_updates(graph, system_message, user_message, thread_id)
