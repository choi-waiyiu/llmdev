...
def test_index_post_request(client):
    ...
    response = client.post('/', data={'system_message': "", 'user_message': USER_MESSAGE_1})
...
def test_memory_persistence_with_session(client):
    ...
    """
    client.post('/', data={'system_message': "", 'user_message': USER_MESSAGE_1})
    client.post('/', data={'system_message': "", 'user_message': USER_MESSAGE_2})
