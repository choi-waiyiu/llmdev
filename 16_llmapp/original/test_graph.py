...
def test_get_bot_response_single_message(setup_memory):
    ...
    """
    response = get_bot_response(SYSTEM_MESSAGE, USER_MESSAGE_1, setup_memory, THREAD_ID)
...
def test_get_bot_response_with_rag(setup_memory):
    ...
    """
    response = get_bot_response(SYSTEM_MESSAGE, USER_MESSAGE_3, setup_memory, THREAD_ID)
    assert isinstance(response, str), "応答は文字列である必要があります。"
...
def test_get_bot_response_multiple_messages(setup_memory):
    ...
    """
    get_bot_response(SYSTEM_MESSAGE, USER_MESSAGE_1, setup_memory, THREAD_ID)
    get_bot_response(SYSTEM_MESSAGE, USER_MESSAGE_2, setup_memory, THREAD_ID)
